...
@register_model_architecture('group_share_transformer', 'group_share_relative_transformer_t2t_wmt_en_de_big')
def group_share_relative_transformer_t2t_wmt_en_de_big(args):
